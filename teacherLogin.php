...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST['userName']) || empty($_POST['userPass'])) {
        ...
        $VAq = "SELECT Password FROM teacher_ogin WHERE Name=?";
        ...
        if (!$stmt->fetch()) {
            ...
            if ($password === $PasswordDB) {
                header("Location: Teacher_Home.php"); // Replace 'home.php' with your actual home page URL
                exit; 
            } else {
...
<body>
    <div class="container">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <input type="Tpassword" name="userPass" id="TuserPass">
